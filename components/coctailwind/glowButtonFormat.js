	...
	return (
		<div className='grid  items-start justify-center'>
			<div className='relative group'>
				<div
					className={`absolute -inset-0.5 bg-gradient-to-r ${gdcolor1} ${gdcolor2} rounded blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt`}></div>
				<a
					href='#footer'
					className='relative py-3 px-12 bg-gradient-to-br from-green-900 via-black to-purple-900  rounded leading-none flex items-center divide-x divide-black'>
